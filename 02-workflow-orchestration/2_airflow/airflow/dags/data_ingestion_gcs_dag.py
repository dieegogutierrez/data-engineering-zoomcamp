...
dataset_file_csv = "yellow_tripdata_2021-01.csv"
...
with DAG(
    ...
    download_dataset_task = BashOperator(
        ...
        bash_command=f"curl -sSL {dataset_url} > {path_to_local_home}/{dataset_file} && gzip -df {path_to_local_home}/{dataset_file}"
    )
